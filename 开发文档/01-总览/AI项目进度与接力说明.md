...
4. 学员通过二维码进入公开问卷时，需要填写姓名、手机号和身份证号完成签到。
5. 签到准入只校验姓名是否匹配当前期数已录入学员；手机号和身份证号作为本次问卷资料保存，不参与准入拦截。
6. 姓名匹配成功后，进入原调查问卷页面；姓名、手机号和身份证号会自动带入，不再让学员重复填写。
...
- 录入学员后，用错误姓名访问问卷，必须被拦截；手机号和身份证号必须填写，但不参与签到准入校验。
- 用正确学员姓名加任意合规手机号/身份证号签到后，确认能进入问卷，且姓名、手机号和身份证号不再重复填写。
